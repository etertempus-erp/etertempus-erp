...
create index idx_expenses_status_origin on expenses(organization_id, status, origin);
create index idx_expenses_supplier on expenses(organization_id, supplier_name);
